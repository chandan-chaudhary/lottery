...
export interface LotteryInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getAllRecentWinners",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getLotteryEntryFee",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Lottery extends BaseContract {
  ...
  getAllRecentWinners: TypedContractMethod<[], [string[]], "view">;
  ...
  getLotteryEntryFee: TypedContractMethod<[], [bigint], "view">;

  getLotteryState: TypedContractMethod<[], [bigint], "view">;
  ...
  setLotteryEntryFee: TypedContractMethod<
    [newEntryFee: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getAllRecentWinners"
  ...
  getFunction(
    nameOrSignature: "getLotteryEntryFee"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getEvent(
    ...
    LotteryEnterEvent.InputTuple,
    LotteryEnterEvent.OutputTuple,
    LotteryEnterEvent.OutputObject
  >;
  getEvent(
  ...
  >;
  getEvent(
    key: "RequestedLotteryWinner"
  ): TypedContractEvent<
    RequestedLotteryWinnerEvent.InputTuple,
    RequestedLotteryWinnerEvent.OutputTuple,
    RequestedLotteryWinnerEvent.OutputObject
  >;
  getEvent(
    key: "WinnerPicked"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "LotteryEnter(address)": TypedContractEvent<
      LotteryEnterEvent.InputTuple,
      LotteryEnterEvent.OutputTuple,
      LotteryEnterEvent.OutputObject
    >;
    LotteryEnter: TypedContractEvent<
      LotteryEnterEvent.InputTuple,
      LotteryEnterEvent.OutputTuple,
      LotteryEnterEvent.OutputObject
    >;
    ...
    "RequestedLotteryWinner(uint256)": TypedContractEvent<
      RequestedLotteryWinnerEvent.InputTuple,
      RequestedLotteryWinnerEvent.OutputTuple,
      RequestedLotteryWinnerEvent.OutputObject
    >;
    RequestedLotteryWinner: TypedContractEvent<
      RequestedLotteryWinnerEvent.InputTuple,
      RequestedLotteryWinnerEvent.OutputTuple,
      RequestedLotteryWinnerEvent.OutputObject
    >;
